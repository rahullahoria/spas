...
<head>
    ...
    <title>BBLoud - Billboard Cloud | Bringing all Digital Billboard to Cloud</title>
...
<nav class="navbar fixed-top navbar-toggleable-md navbar-inverse navbar-expanded" id="mainNav">
    <div class="container">
        ...
        <a class="navbar-brand page-scroll" href="#page-top">
            <img class="img-fluid" src="img/agency/icon1.png" alt=""> BBLoud
        </a>
    ...
    <div class="container h-100">
        <div class="row h-100">
            <div class="col-12 my-auto text-center text-white">
                <img class="masthead-img img-fluid mb-3" src="img/agency/icon1.png" alt="">
                <div class="masthead-title">Sell billboard ads in minutes
                </div>
                <hr class="colored">
                <div class="masthead-subtitle">Join the nation's largest online independent billboard network</div>
            </div>
        </div>
    </div>
...
<section class="page-section" id="about">
    <div class="container-fluid">
        <div class="wow fadeIn text-center">
            <h1>Why Use?</h1>
            <p class="mb-0">Introducing BBLoud, the first automated buying platform for billboards and digital signage.
                ...
                BBLoud also appeals to the thousands of regional and local advertising agencies, as well as online, SEO and digital agencies who want to incorporate outdoor advertising into their clients’ media mix.</p>
        </div>
        <hr class="colored">
...
<!-- <section class="page-section bg-faded" id="team">
     <div class="container text-center wow fadeIn">
         ...
         <div class="team-carousel owl-carousel owl-theme mt-4">
             ...
             &lt;!&ndash; Team Carousel Item 1 &ndash;&gt;
             <div class="item">
                 <div class="overlay"></div>
             ...
             &lt;!&ndash; Team Carousel Item 2 &ndash;&gt;
             <div class="item">
                 <div class="overlay"></div>
             ...
             &lt;!&ndash; Team Carousel Item 3 &ndash;&gt;
             <div class="item">
                 <div class="overlay"></div>
             ...
             &lt;!&ndash; Team Carousel Item 4 &ndash;&gt;
             <div class="item">
                 <div class="overlay"></div>
             ...
             &lt;!&ndash; Team Carousel Item 5 &ndash;&gt;
             <div class="item">
                 <div class="overlay"></div>
    ...
    <div class="container wow fadeIn">
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <a class="btn btn-primary page-scroll" href="#services">How it Works</a>
                <hr s="colored">
                <span class="quote">
                    <h4>Good <span class="text-primary">BBLoud</span> is all about giving you options to access new advertisers. At the simplest level, you can list your digital billboard or LED sign on our online inventory network map allow potential buyers to browse and learn more about your asset(s). Take advantage of our internet sales and marketing activities and showcase your billboards on BBLoud. When advertisers are interested in purchasing inventory, you'll be notified immediately.

<br>
<br>
                        Want to enable online sales as soon as today? Integrate your billboard and enable online package, contract or real-time bidding buys. BBLoud allows operators to sell guaranteed and non-guaranteed advertisements.
                    </h4>
                </span>
...
<section class="page-section services" id="services">
    <div class="container">
        <div class="text-center wow fadeIn">
            <h2>Benefits</h2>
            <hr class="colored">
            <p class="mb-0">Here is how we make change in advertising</p>
        </div>
        <div class="row mt-4">
            <!-- Service Item 1 -->
            <div class="col-lg-4 wow fadeIn" data-wow-delay=".2s">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        Billboard owners can establish an immediate online presence with the leader in automated online OOH buying. Leverage BBLoud’s singular focus on OOH and our marketing and technology investment to expose your billboards to millions of digital national, regional and small ad buyers.
                    </div>
                </div>
            </div>
            <!-- Service Item 2 -->
            ...
            <div class="col-lg-4 wow fadeIn" data-wow-delay=".2s">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        Leverage BBLoud features to attract and retain advertisers with coupons, social media integration, referral programs, mobile apps, and day parting. BBLoud allows billboard owners to sell different products to different markets driving up occupancy and rates.
                    </div>
                </div>
            </div>
            <!-- Service Item 2 -->
            ...
            <div class="row h-100">
                <div class="col-md-5 push-md-7 my-auto">
                    <div class="project-details">
                        <span class="project-name">SPAS Private Billboard</span>
                            <span class="project-description">BBLoud is your local online marketing partner and is available 24/7 365 days a year. BBLoud appeals to advertisers, agencies and digital strategists who want to include Out-of-Home (OOH) in their marketing campaigns and are already buying other forms of media online including digital, social and other media. BBLoud simplifies and streamlines the billboard ad buying process and is attractive to advertisers with budgets of any size.
...
BBLoud's experience is designed to make billboard advertising as easy as possible, while providing you flexibility to create a campaign that suits your needs and helps you reach the right audience at the right time.
</span>
                        <hr class="colored">
                ...
                <div class="col-md-7 pull-md-5 hidden-xs my-auto">
                    <div class="device-container">
                        <div class="device-mockup macbook portrait black">
                            <div class="device">
                                <div class="screen">
                                    <img class="img-fluid" src="img/spas_Tab.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="item" style="background-image: url('img/agency/portfolio/carousel/bg-2.jpg')">
        <div class="container-fluid">
            <div class="row h-100">
                <div class="col-md-5 push-md-7 my-auto">
                    <div class="project-details">
                        <span class="project-name">SPAS Public BB</span>
                        <span class="project-description">BBLoud provides several options for advertisers to execute ad buys: Packages, Real-Time Bidding, and Contracting. It is all about providing options and flexibility to advertisers and digital marketing experts. Advertisers can buy guaranteed impressions and set up campaigns using the Packages and Contracting functionality. Real-Time Bidding allows advertisers to bid for inventory and execute campaigns on demand in real-time.

We make the buying of outdoor advertising transparent and help you understand how much billboard ads cost. Each buying option provides functionality never available before to advertisers in the billboard industry.</span>
                        <hr class="colored">
                ...
                <div class="col-md-7 pull-md-5 hidden-xs my-auto">
                    <div class="device-container">
                        <div class="device-mockup macbook portrait black">
                            <div class="device">
                                <div class="screen">
                                    <img class="img-fluid" src="img/mxq3.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="testimonials-carousel">
                    &lt;!&ndash; Testimonial Item 1 &ndash;&gt;
                    <div class="item mb-4">
                        <p class="lead">"Working with BBLoud was both a valuable and rewarding experience."</p>
                        <hr class="colored">
                    ...
                    &lt;!&ndash; Testimonial Item 2 &ndash;&gt;
                    <div class="item mb-4">
                        <p class="lead">"BBLoud is a well coded, well documented, and easy to use theme!"</p>
                        <hr class="colored">
...
<a class="btn btn-block btn-full-width" href="https://wrapbootstrap.com/theme/vitality-multipurpose-one-page-theme-WB02K3KK3">Buy BBLoud Now!</a>
    ...
    <div class="container text-center">
        <div class="row">
            ...
            <div class="col-md-4 footer-contact-details">
                ...
                <p>#815/31, Sector 31,
                    <br>Gurgaon, Delhi NCR</p>
            </div>
            <div class="col-md-4 footer-contact-details">
                <h4><i class="fa fa-envelope"></i> Email</h4>
                <p><a href="mailto:mail@example.com">info@bbloud.com</a>
                </p>
            </div>
        </div>
        ...
        <p class="copyright">&copy; 2017 by Shatkon Labs Pvt. Ltd.</p>
    </div>
</footer>
