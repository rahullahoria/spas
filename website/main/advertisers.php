    ...
    <div class="container h-100">
        <div class="row h-100">
            <div class="col-12 my-auto text-center text-white">
                ...
                <div class="masthead-title">Start advertising on boards in minutes
                </div>
                <hr class="colored">
                <div class="masthead-subtitle">Access the nation's largest independent online digital billboard network</div>
            </div>
        </div>
    </div>
...
<section class="page-section" id="about">
    <div class="container-fluid">
        <div class="wow fadeIn text-center">
            <h1>Why Use?</h1>
            <p class="mb-0">BBLoud is the first automated on-line buying platform for billboards. From building your campaign, creating artwork, to making payments, and monitoring campaign effectiveness we make it easy to buy and execute billboard campaigns.</p>
        </div>
        <hr class="colored">
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-4 wow fadeIn" data-wow-delay=".2s">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        Advertisers rave about buying billboards through BBLoud. It's never been easier to manage your campaign from a browser or mobile device. You may never go back to doing it the old way again.
                    </div>
                </div>
            </div>
            <!-- Service Item 2 -->
            ...
            <div class="col-lg-4 wow fadeIn" data-wow-delay=".6s">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3 class="media-heading">Unlimited Access</h3>
            ...
            <div class="col-lg-4 wow fadeIn" data-wow-delay=".6s">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        BBLoud is your local on-line marketing partner. Whether you need help building a campaign, finding the right board, creating an ad, or determining which ad strategy will be most effective for your business, we're here for you.
                    </div>
                </div>
            </div>
        </div>
