        ...
        <div class="container h-100">
            <div class="row h-100">
                <div class="col-12 my-auto text-center text-white">
                    ...
                    <div class="masthead-title">Digital billboard advertising, made easy.
                        </div>
                    <hr class="colored">
                    <div class="masthead-subtitle">Choose your boards, upload your ads, make your impression - start with any budget.</div>
                </div>
            </div>
        </div>
    ...
    <section class="page-section" id="about">
        <div class="container-fluid">
            <div class="wow fadeIn text-center">
                <h1>Who Can Use?</h1>
                <p class="mb-0">Targeting right audience is a challenge for a brand. Showing ads without knowing your customers is waste of money. Product are created considering a specific demographics. SPAS gives a solution for dynamic advertisements for digital billboards, which target audience based on demographics.</p>
            </div>
            <hr class="colored">
                ...
                <div class="row h-100">
                    <div class="col-md-5 push-md-7 my-auto">
                        <div class="project-details">
                            <span class="project-name">SPAS Tabs</span>
                            <span class="project-description">Advertisement and marketing channels are so crowded, brands are running the ads. But customer even don’t bother to notice the brands. So, there is need of
<ol>
    <li>
    Very smart targeting of ads
        </li><li>
Cost effective channels
</li><li>
Trapping the right time, where customer is under free time
</li><li>Area targeted
</li><li>Fast delivery system</li></ol>
</span>
                            <hr class="colored">
        ...
        <div class="item" style="background-image: url('img/agency/portfolio/carousel/bg-2.jpg')">
            <div class="container-fluid">
                <div class="row h-100">
                    <div class="col-md-5 push-md-7 my-auto">
                        <div class="project-details">
                            <span class="project-name">SPAS Box</span>
                            <span class="project-description">SPAS ( Smart Public Advertisement System ) box is small box, which is 2 time smaller then setup box and create your digital billboard to cloud billboard. Results cost savings and increase in profit.</span>
                            <hr class="colored">
